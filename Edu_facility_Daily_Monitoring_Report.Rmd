...
df %>% kable( longtable = T, booktabs = T, linesep = "",caption="Surveys in which respondent says the age range is (pre paimary and class 6-10) or (1-5 and 11-12) at a time") %>% kable_styling(position = "center")
```
...
) %>% dplyr::filter(total_teacher > 50) %>% select(c("reported_date","X_uuid","male_teachers_per_education_facility",
