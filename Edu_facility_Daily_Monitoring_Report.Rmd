...
data$education_facilities_charging_fees_3 == "yessome") %>% 
  ...
  dplyr::select(c("reported_date","X_uuid","education_facilities_charging_fees_3","education_facility_providing_transportation")
...
all_frequency <- data %>% dplyr::select(contains("education_facilities_charging_fees_by_frequency")) %>%
  dplyr::select(-contains("_other"))  %>% colnames()
all_fees <- data %>% dplyr::select(starts_with("average_education_facility")) %>% colnames() 

a2 <-data %>%  dplyr::mutate(fees_annually = if_else(tuition_education_facilities_charging_fees_by_frequency == "monthly", 
                                                     as.integer(data$tuition_education_facilities_charging_fees*12) ,
                                                     if_else(tuition_education_facilities_charging_fees_by_frequency == "quarterly",
                                                             ...
                                                             as.integer(data$tuition_education_facilities_charging_fees), NULL))) %>% dplyr::select(
                                                               c("reported_date","X_uuid","fees_annually")) # %>% dplyr::filter(fees_annually > 2000)


a3 <-data %>%  dplyr::mutate(fees_annually = if_else(education_facilities_charging_fees_by_frequency3 == "monthly", 
...
a4 <-data %>% dplyr::mutate(fees_annually = if_else(education_facilities_charging_fees_by_frequency4 == "monthly", 
...
a5 <-data %>% dplyr::mutate(fees_annually = if_else(education_facilities_charging_fees_by_frequency5 == "monthly", 
...
a6 <-data %>% dplyr::mutate(fees_annually = if_else(education_facilities_charging_fees_by_frequency6 == "monthly", 
...
a7 <-data %>% dplyr::mutate(fees_annually = if_else(education_facilities_charging_fees_by_frequency7 == "monthly", 
...
a8 <-data %>% dplyr::mutate(fees_annually = if_else(education_facilities_charging_fees_by_frequency8 == "monthly", 
...
a9 <-data %>% dplyr::mutate(fees_annually = if_else(education_facilities_charging_fees_by_frequency9 == "monthly", 
...
a10 <-data %>% dplyr::mutate(fees_annually = if_else(education_facilities_charging_fees_by_frequency10 == "monthly", 
...
a11 <-data %>% dplyr::mutate(fees_annually = if_else(education_facilities_charging_fees_by_frequency11 == "monthly", 
...
df <- rbind(a2,a3,a4,a5,a6,a7,a8,a9,a10,a11) %>% dplyr::filter(!is.na(fees_annually))
...
df3 %>% kable( longtable = T, booktabs = T, linesep = "",caption="Surveys in which respondent says the fees of any facility is greater than 2000") %>% kable_styling(position = "center")
